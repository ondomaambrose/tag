      ...
      <button
        ...
        className={`w-full p-5 text-left rounded-xl border-2 transition-all duration-200 group ${
          userAnswers[q.id] === opt
            ...
            : "border-gray-100 hover:border-blue-300 hover:bg-white bg-gray-50 text-gray-700"
        }`}
      >
      ...
      <button
        ...
        className={`flex-1 p-6 rounded-xl border-2 text-lg font-semibold transition-all ${
          userAnswers[q.id] === val
            ...
            : "border-gray-100 bg-gray-50 hover:border-blue-300 hover:bg-white text-gray-600"
        }`}
      >
        {val ? "True" : "False"}
      </button>
        ...
        >
          ...
          {field.fieldType === "fill_in" ? (
            ...
            <div className="relative">
              <select
                className="w-full p-3 border border-gray-300 rounded-lg bg-white appearance-none focus:ring-2 focus:ring-blue-500 outline-none"
                value={currentAnswers[idx] || ""}
                onChange={(e) => handleFieldChange(idx, e.target.value)}
              >
